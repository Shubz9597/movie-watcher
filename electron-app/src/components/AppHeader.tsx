...
export default function AppHeader({ navigate }: { navigate: (path: string, params?: Record<string, string>) => void }) {
  useEffect(() => {
    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#03060c]/70 backdrop-blur-lg">
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4">
        <button
          ...
          className="inline-flex items-center gap-2 text-lg font-semibold text-white hover:opacity-80"
        >
